...
public class TimeOfDayFrame : ControlFrame
{
    ...
    public TimeOfDayFrame(OMCW omcw, int timeZone, DayOfWeek dayOfWeek, int month, int dayOfMonth, int hours,
        int minutes, int seconds, bool isPM)
    {
        this.omcw = omcw;
        ...
        */
        ...
        frame[11] = (byte)((byte)dayOfWeek + 1); // Day of Week
